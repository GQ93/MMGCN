...
def inference(input_x1, input_x2, input_lap1, input_lap2, input_dim1, input_dim2):
    ...
    Returns:
        logits and penalty
    """
    z1, z2, r1, r2, l21w = ly.ManifoldMultitasklearning(x1=input_x1, lap1=input_lap1, input_dim1=input_dim1, x2=input_x2, lap2=input_lap2, input_dim2=input_dim2)
    r = r1 + r2
    return z1, z2, r, l21w
...
def training(loss, r, l21w, learning_rate):
    ...
    loss += configM2TL.scale_L21 * l21w + configM2TL.scale_of_Lap * r
