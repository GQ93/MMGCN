...
def run_training():
    ...
    # Forward propagation
    # build the graph
    z1, z2, r, l21w = M2TL.inference(input_x1=input_x1, input_x2=input_x2, input_lap1=input_L1, input_lap2=input_L2, input_dim1=d1, input_dim2=d2)
    # loss function
    loss, l1, l2 = M2TL.loss(z1=z1, z2=z2, labels=input_labels)
    mae_emoid = M2TL.MAE(labels=input_labels, logits=z1)
    mae_nback = M2TL.MAE(labels=input_labels, logits=z2)
    # Add to the Graph the Ops that calculate and apply gradients.
    train_op = M2TL.training(loss=loss, r=r, l21w=l21w, learning_rate=configM2TL.learning_rate)
    ...
    for step in range(configM2TL.max_steps):
    ...
    # Write the summaries and print an overview fairly often.
        ...
        if (step + 1) % 100 == 0 or (step + 1) == configM2TL.max_steps:
